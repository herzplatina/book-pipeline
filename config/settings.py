...
REDDIT_DM_DAILY_LIMIT   = int(os.environ.get('REDDIT_DM_DAILY_LIMIT', '10'))
...
REDDIT_KEYWORDS = [
    'started a business', 'entrepreneur', 'built something',
    'second chance', 'turned my life around', 'got out and',
    'healed from', 'sober and now', 'lost my job and',
]
...
CITIES = [
    ...
    ('Pittsburgh, Pennsylvania, United States', ['post-gazette.com', 'wesa.fm', 'triblive.com']),
    ('Cleveland, Ohio, United States',          ['cleveland.com', 'crainscleveland.com', 'ideastream.org']),
    ('Tulsa, Oklahoma, United States',          ['tulsaworld.com', 'tulsapeople.com', 'kjrh.com']),
    ('Louisville, Kentucky, United States',     ['courier-journal.com', 'wdrb.com', 'louisvillemag.com']),
    ('Memphis, Tennessee, United States',       ['commercialappeal.com', 'dailymemphian.com', 'wreg.com']),
    ('Fresno, California, United States',       ['fresnobee.com', 'kvpr.org', 'abc30.com']),
    ('El Paso, Texas, United States',           ['elpasotimes.com', 'kvia.com', 'elpasomatters.org']),
]
...
STORYCORPS_SEARCH_TAGS = ['health', 'recovery', 'resilience', 'second chance', 'immigration']
MOTH_SEARCH_TAGS       = ['transformation', 'identity', 'illness', 'crime', 'immigration']
...
APOLLO_SEARCH_PAYLOAD = {
    ...
    'q_organization_industry_tag_ids': [
        ...
        'hospitality', 'retail', 'food_and_beverage',
    ],
    'employment_history': {
