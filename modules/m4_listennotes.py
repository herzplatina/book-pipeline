...
def _extract_interviewee_profile(
    ...
    try:
        ...
        # This LLM pass is optional: any failure (API error, malformed JSON,
        # unexpected response shape) must degrade to the base profile rather
        # than abort discovery for the whole run.
