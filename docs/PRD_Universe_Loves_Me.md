...
| :---------------------------- | :------------------------------------------- | :--------- | :-------------- | :-------------------------------------------------------------------------------------------------------------------------------------- | :---------------------- |
| YouTube (personal channel)    | Health testimony, recovery, gig driver plans | 3, 4       | 5–10%           | Video description/transcript email only; keep channel URL for manual review                                                             | Email or platform DM    |
...
| ListenNotes (podcast guests)  | All archetypes                               | All        | 50–60%          | Show notes: deterministic name extraction first, then Haiku fallback only if unresolved; email first, then guest/personal website links | Email or platform DM    |
